...
#####funciones#######################
def valorHamburguesa(subTotal,precio):
...
for i in range(0,cantHam):
    ...
    if (pan == 1):
        subTotal = valorHamburguesa(subTotal,1000)
    else:
        subTotal = valorHamburguesa(subTotal,1500)
    ...
    if (carne == 1):
        subTotal = valorHamburguesa(subTotal,5000)
    else:
        subTotal = valorHamburguesa(subTotal,7000)
    ...
    if (pollo == 1):
        subTotal = valorHamburguesa(subTotal,4500)
    else:
        subTotal = valorHamburguesa(subTotal,5500)
    ...
    if (polloD == 1):
        subTotal = valorHamburguesa(subTotal,6500)
    else:
        subTotal = valorHamburguesa(subTotal,7500)
    ...
    if (tocineta == 1):
        ...
        subTotal = valorHamburguesa(subTotal,2500)
    ...
    if (papaF == 1):
        ...
        subTotal = valorHamburguesa(subTotal,6000)
    ...
    if (bebida == 1):
        ...
        subTotal = valorHamburguesa(subTotal,8000)
    else:subTotal = valorHamburguesa(subTotal,9000)
